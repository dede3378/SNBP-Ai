...
const styles = StyleSheet.create({
  ...
  pickerItemMismatch: { backgroundColor: Colors.warningLight + "40" },
  ...
  pickerMismatchBadge: { flexDirection: "row", alignItems: "center", gap: 4, marginTop: 4 },
  pickerMismatchText: { fontSize: 10, fontFamily: "Inter_500Medium", color: Colors.warning },
  mismatchWarning: {
    flexDirection: "row", alignItems: "center", gap: 8,
    backgroundColor: Colors.warningLight, borderRadius: 8,
    padding: 10, marginTop: 8,
  },
  mismatchText: { fontSize: 12, fontFamily: "Inter_400Regular", color: Colors.warning, flex: 1 },
